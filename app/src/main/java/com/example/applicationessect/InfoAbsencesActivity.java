...
public class InfoAbsencesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.info_absences);  // Ensure your layout is correct
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (!querySnapshot.isEmpty()) {
                            ...
                            Toast.makeText(InfoAbsencesActivity.this, "Aucune absence trouvée.", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        // Handle any errors during the Firestore query
                        Toast.makeText(InfoAbsencesActivity.this, "Erreur lors de la récupération des informations", Toast.LENGTH_SHORT).show();
                    }
                });
    }
